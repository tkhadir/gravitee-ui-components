...
describe('P O L I C Y  S T U D I O', () => {
  ...
  describe('C O M M O N', () => {
    ...
    test('should create element', () => {
      ...
      expect(element.definedProperties.length).toEqual(0);
    });
  ...
  describe('A P I M', () => {
    ...
    test('should find collection of flow', () => {
      const flowIdFromApiDefinition = component.definition.flows[0]._id;
      const flowIdFromPlanDefinition = component.definition.plans[1].flows[0]._id;
      expect(component._findFlowCollection(flowIdFromApiDefinition)).toEqual(component.definition.flows);
      expect(component._findFlowCollection(flowIdFromPlanDefinition)).toEqual(component.definition.plans[1].flows);
    });
    ...
    test('should create element with definition', () => {
      ...
      expect(component.definedProperties.length).toEqual(3);
      expect(component.definedFlows[0]._id).toBeDefined();
      expect(component.definedResources[0]._id).toBeDefined();
      expect(component._selectedFlowsId.length).toEqual(1);
    });
  ...
  describe('F L O W S', () => {
    ...
    test('should duplicate flow', () => {
      const flow = { name: 'ALL', post: [{ policy: 'rate-limit', name: 'Rate limit' }], pre: [] };
    ...
    test('should update definition when submit schema form with updated flow', () => {
      ...
      const updatedFlow = { name: 'Updated flow', description: 'more....', methods: ['GET', 'POST'] };
      ...
      expect(component.definition.flows[0].path).toEqual('');
